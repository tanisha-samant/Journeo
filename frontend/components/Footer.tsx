        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-2xl font-bold">Journeo</h3>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              AI-powered travel planning that makes your journey unforgettable. 
              Get personalized itineraries, real-time updates, and everything you need for the perfect trip.
            </p>
